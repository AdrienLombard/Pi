...
public class Main {
	...
	public static void main(String[] args) {
		...
		if(fin - deb < 1000) {
			temps = "Généré en " + (fin - deb) + " millisecondes\r\n";
		}
		else {
			temps = "Généré en " + ((fin - deb) / 1000) + " secondes et " + ((fin - deb) - ((fin - deb) / 1000 * 1000)) + " millisecondes\r\n";
		}
		...
		try {
			...
			System.out.println("Temps d'execution : " + (System.currentTimeMillis() - debProg) + " millisecondes");
		}
